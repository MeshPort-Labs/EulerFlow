// src/components/PropertyPanel/configs/formConfigs.ts
import type { 
    CoreActionNodeData, 
    LpToolkitNodeData, 
    StrategyNodeData, 
  ...
  // Mock data - replace with your actual vault/token data
  export const mockVaults = [
    { value: '0x1234...5678', label: 'USDC - USD Coin Vault', description: 'Stablecoin vault', badge: 'Stable' },
    { value: '0x2345...6789', label: 'WETH - Wrapped Ethereum Vault', description: 'Native ETH vault', badge: 'Native' },
    { value: '0x3456...7890', label: 'DAI - Dai Stablecoin Vault', description: 'Decentralized stablecoin', badge: 'Stable' },
    { value: '0x4567...8901', label: 'USDT - Tether USD Vault', description: 'Centralized stablecoin', badge: 'Stable' },
    { value: '0x5678...9012', label: 'wstETH - Wrapped Staked ETH Vault', description: 'Liquid staking token', badge: 'LST' },
  ];
